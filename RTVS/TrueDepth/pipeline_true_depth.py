...
def save_mask(depth_img, step, rgb_image, img_name):
    ...
    folder = "/ssd_scratch/shankara/VS_obs/RTVS/TrueDepth/save_mask"
    folder1 = "/ssd_scratch/shankara/VS_obs/RTVS/TrueDepth/save_rgb"
    ...
    keep_mask = depth_img < 0.5
    
    cv2.imwrite("/ssd_scratch/shankara/VS_obs/RTVS/TrueDepth/save_mask/" +  img_name + "/" + "_.%05d.png" % (step), keep_mask * 255)
    cv2.imwrite("/ssd_scratch/shankara/VS_obs/RTVS/TrueDepth/save_rgb/" +  img_name + "/" + "_.%05d.png" % (step), rgb_image)
...
def plan(pre_img_src):
    ...
    while True:
        ...
        mask = save_mask(depth_img, step, img_src, target )
