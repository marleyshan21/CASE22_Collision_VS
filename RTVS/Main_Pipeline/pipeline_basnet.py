...
def save_mask(mask, step, rgb_image, img_name):
    ...
    folder = "/ssd_scratch/shankara/VS_obs/RTVS/Main_Pipeline/save_mask"
    folder1 = "/ssd_scratch/shankara/VS_obs/RTVS/Main_Pipeline/save_rgb"
    ...
    cv2.imwrite("/ssd_scratch/shankara/VS_obs/RTVS/Main_Pipeline/save_mask/" +  img_name + "/" + "_.%05d.png" % (step), keep_mask * 255)
    cv2.imwrite("/ssd_scratch/shankara/VS_obs/RTVS/Main_Pipeline/save_rgb/" +  img_name + "/" + "_.%05d.png" % (step), rgb_image)
    ...
    while True:
        ...
        if obthere:
            ...
            if z == '1':
                ...
                if step <0:
                    client.moveByVelocityAsync(0, 0, 0 , 5,drivetrain = airsim.DrivetrainType.ForwardOnly, yaw_mode=airsim.YawMode(True, 50))
                else :
                    client.moveByVelocityBodyFrameAsync(1, 0, 0 , 5,drivetrain = airsim.DrivetrainType.ForwardOnly, yaw_mode=airsim.YawMode(True, 0))
                    temp_var = False
